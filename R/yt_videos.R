#' @title YouTube Videos API node
#' @description Access the YouTube Videos API node
#' @param part The part parameter specifies a comma-separated list of one or more channel resource properties that the API response will include. Valid parameters can be found here: https://developers.google.com/youtube/v3/docs/videos/list.
...
yt_videos <- function(part, id, maxResults = NULL, pageToken = NULL, api.key){

  # Set base API call
  link <- "https://www.googleapis.com/youtube/v3/videos?"

  # Add part parameter
  part_par <- c("contentDetails", "fileDetails", "id", "liveStreamingDetails", "localizations",
