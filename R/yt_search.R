...
#' @examples
#' \dontrun{
#' video_search <- yt_search_list(query = INSERT_QUERY,
#'                         maxResults = 50,
...
yt_search <- function(query, type = "video", location = NULL, locationRadius = NULL, radiusUnit = NULL, maxResults = NULL, pageToken = NULL, publishedAfter = NULL, publishedBefore = NULL, api.key){
